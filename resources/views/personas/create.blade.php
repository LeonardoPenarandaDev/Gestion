        ...
        <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 12px; box-shadow: 0 10px 25px rgba(0,0,0,0.1);">
            <div style="padding: 2rem; text-align: center;">
                ...
                <p style="color: rgba(255,255,255,0.8); margin-top: 0.5rem; font-size: 0.9rem;">
                    Registra una nueva persona en el sistema electoral
                </p>
            </div>
        </div>
    </x-slot>
            ...
            <div class="modern-form-container fade-in">
                ...
                <div class="form-header">
                    <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem;">
                        <div>
                            <h3 style="font-size: 1.5rem; font-weight: 700; margin: 0; color: #1f2937;">Agregar Nueva Persona</h3>
                            <p style="color: #6b7280; margin: 0.5rem 0 0 0;">Complete la información para registrar una nueva persona</p>
                        </div>
                        <a href="{{ route('personas.index') }}" class="btn-back">
                ...
                <div class="form-content">
                    <form action="{{ route('personas.store') }}" method="POST">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                <label for="ocupacion" class="form-label">
                                    <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="margin-right: 0.5rem;" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2-2v2m8 0V6a2 2 0 012 2v6a2 2 0 01-2 2H6a2 2 0 01-2-2V8a2 2 0 012-2V6z"></path>
                                    </svg>
                                    Ocupación
                                </label>
                                <div class="input-icon">
                        ...
                        <div class="form-actions">
                            <a href="{{ route('personas.index') }}" class="btn-secondary">
                                <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="margin-right: 0.5rem;" stroke-width="2">
