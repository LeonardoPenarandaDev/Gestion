        ...
        <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 12px; box-shadow: 0 10px 25px rgba(0,0,0,0.1);">
            <div style="padding: 2rem; text-align: center;">
                ...
                <p style="color: rgba(255,255,255,0.8); margin-top: 0.5rem; font-size: 0.9rem;">
                    Administra el registro de personas del sistema electoral
                </p>
            </div>
        </div>
    </x-slot>
            ...
            <div class="modern-container fade-in">
                ...
                <div class="header-section">
                    <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem;">
                        <div>
                            <h3 style="font-size: 1.5rem; font-weight: 700; margin: 0; color: #1f2937;">Lista de Personas</h3>
                            <p style="color: #6b7280; margin: 0.5rem 0 0 0;">Administra y visualiza todas las personas registradas</p>
                        </div>
                        <a href="{{ route('personas.create') }}" class="btn-primary">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="display: flex; align-items: center;">
                                        @if($persona->telefono)
                                            <svg width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="margin-right: 0.5rem; color: #10b981;" stroke-width="2">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                                            </svg>
                                            {{ $persona->telefono }}
                                        @else
                                ...
                                <td>
                                    <div style="display: flex; align-items: center;">
                                        @if($persona->email)
                                            <svg width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="margin-right: 0.5rem; color: #3b82f6;" stroke-width="2">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M16 12a4 4 0 10-8 0 4 4 0 008 0zm0 0v1.5a2.5 2.5 0 005 0V12a9 9 0 10-9 9m4.5-1.206a8.959 8.959 0 01-4.5 1.207"></path>
                                            </svg>
                                            {{ $persona->email }}
                                        @else
                                ...
                                <td>
                                    <div style="display: flex; flex-wrap: wrap; gap: 0.5rem;">
                                        <a href="{{ route('personas.show', $persona) }}" class="action-btn btn-view">
                                        ...
                                        <a href="{{ route('personas.edit', $persona) }}" class="action-btn btn-edit">
                                            <svg width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="margin-right: 0.25rem;" stroke-width="2">
                                        ...
                                        <form action="{{ route('personas.destroy', $persona) }}" method="POST" style="display: inline;">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="action-btn btn-delete" onclick="return confirm('¿Está seguro de eliminar esta persona?')">
                                                <svg width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="margin-right: 0.25rem;" stroke-width="2">
                            ...
                            <tr>
                                <td colspan="5">
                                    <div class="empty-state">
                                        ...
                                        <h4 style="font-size: 1.25rem; font-weight: 600; margin: 0 0 0.5rem 0; color: #374151;">No hay personas registradas</h4>
                                        <p style="color: #6b7280; margin: 0 0 1.5rem 0;">Comienza agregando la primera persona al sistema</p>
                                        <a href="{{ route('personas.create') }}" class="btn-primary">
                                            <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="margin-right: 0.5rem;" stroke-width="2">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                                            </svg>
