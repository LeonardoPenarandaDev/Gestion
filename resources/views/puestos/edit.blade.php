                ...
                <div class="form-header">
                    <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem;">
                        <div>
                            ...
                            <p style="color: #6b7280; margin: 0.5rem 0 0 0;">Modifica los datos del puesto: {{ $puesto->nombre ?? $puesto->puesto }}</p>
                        </div>
                        <a href="{{ route('puestos.show', $puesto) }}" class="btn-back">
                ...
                <div class="form-content">
                    <div class="info-card">
                        ...
                        <div class="info-card-text">
                            Los campos marcados con <strong>*</strong> son obligatorios. Verifica la información antes de guardar.
                        </div>
                    </div>
                    ...
                    <form action="{{ route('puestos.update', $puesto) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="direccion" id="direccion" rows="3" 
                                      ...
                                      maxlength="200"
                                      required>{{ old('direccion', $puesto->direccion) }}</textarea>
                            @error('direccion')
                                <div class="error-message">
                                    <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="margin-right: 0.25rem;" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-icon">
                                    ...
                                    <input type="number" name="total_mesas" id="total_mesas" 
                                           value="{{ old('total_mesas', $puesto->total_mesas) }}"
                                           class="form-input"
                                           placeholder="0"
                                           min="1"
                                           max="99"
                        ...
                        <div class="form-actions">
                            <a href="{{ route('puestos.show', $puesto) }}" class="btn-secondary">
                                <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="margin-right: 0.5rem;" stroke-width="2">
