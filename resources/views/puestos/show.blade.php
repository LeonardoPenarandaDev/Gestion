                ...
                <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem;">
                    <div>
                        ...
                        <p style="color: rgba(255,255,255,0.8); margin-top: 0.5rem; font-size: 0.9rem;">
                            Información completa del puesto de votación
                        </p>
                    </div>
                    <a href="{{ route('puestos.index') }}" style="background: rgba(255,255,255,0.2); color: white; border: 1px solid rgba(255,255,255,0.3); padding: 0.75rem 1.5rem; border-radius: 10px; font-weight: 500; text-decoration: none; display: inline-flex; align-items: center; gap: 0.5rem; transition: all 0.3s ease;">
    ...
    <div class="detail-container fade-in">
        ...
        <div class="profile-sidebar">
            ...
            <div class="stats-grid">
                <div class="stat-item">
                    <div class="stat-number">{{ $puesto->zona ?? '0' }}</div>
            ...
            <div class="action-buttons">
                <a href="{{ route('puestos.edit', $puesto) }}" class="btn-edit">
                    <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                    </svg>
                    Editar
                </a>
                <form action="{{ route('puestos.destroy', $puesto) }}" method="POST" style="display: inline;" onsubmit="return confirm('¿Está seguro de eliminar este puesto?')">
                    @csrf
                    @method('DELETE')
                    ...
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <div class="info-value">
                                <span class="zone-badge">{{ $puesto->zona ?? 'Sin zona' }}</span>
                            </div>
                        </div>
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-value">{{ $puesto->puesto ?? 'N/A' }}</div>
                        </div>
            ...
            <div class="detail-card">
                ...
                <div class="card-body">
                    <div class="info-item" style="grid-column: span 2;">
                        ...
                        <div class="info-value">{{ $puesto->nombre ?? 'Sin nombre' }}</div>
                    </div>

                    <div class="info-item" style="grid-column: span 2; margin-top: 1rem;">
                        <div class="info-label">
                            <svg width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
                ...
                <div class="card-body">
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <div class="info-value">
                                {{ $puesto->created_at ? $puesto->created_at->format('d/m/Y H:i') : 'N/A' }}
                            </div>
                        </div>
                        ...
                        <div class="info-item">
                            ...
                            <div class="info-value">
                                @if($puesto->updated_at && $puesto->updated_at != $puesto->created_at)
